...
printf("Right Hand Side\n");_flushall();
	...
	*error = 0;
	...
	thrust_mag = 0.0;//u[3];				// Get optimised normalised thrust magnitude
...
//			break;
	...
	julian_date = EPOCH + rpar[0] + time;				// = reference time + start time + elapsed mission time [days]
	...
	case 2:
		...
		solar_rad_pressure_cart(julian_date, mass, r_vec, center, pertsolp_cart);
