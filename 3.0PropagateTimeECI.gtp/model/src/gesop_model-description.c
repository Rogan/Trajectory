...
//		{"Science",	-1, "Science orbit: stationkeeping only",		-1},
	...
	static DLL_Unit_Item Time_Description  = 
		{"tn",	-1, "Normalised elapsed Time t",	-1, "None",	-1};
	
	static DLL_Item Initial_Cost_Item =		{"",	-1, "",	-1};
	
	static DLL_Item Integral_Cost_Item =	{"",	-1, "",	-1};
	
	static DLL_Item Terminal_Cost_Item =	{"TC_mass",	-1, "Maximise final mass",	-1};
	...
	static DLL_Constraint_Item IBCon[8] =
	{
		{"IBC_p_LCI",				-1, "pmee",											-1, true,	true},
		{"IBC_f_LCI",				-1, "fmee",											-1, false,	true},
		{"IBC_g_LCI",				-1, "gmee",											-1, true,	true},
		{"IBC_h_LCI",				-1, "hmee",											-1, true,	true},
		{"IBC_k_LCI",				-1, "kmee",											-1, true,	true},
		{"IBC_L_LCI",				-1, "Lmee",											-1, true,	true},
		{"IBC_t",					-1, "Time",											-1, true,	true},
		{"IBC_m",					-1, "Mass",											-1, true,	true},
	};
	
	static DLL_Constraint_Item FBCon[1]=
	{
		{"FBC_altitude",			-1, "Lunar altitude",								-1, false,	true},
	};
