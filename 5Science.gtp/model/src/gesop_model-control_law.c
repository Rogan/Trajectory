...
const double Ini_p = 1.8374e6;			// [m] a(1-e²)
const double Ini_f = 0.0;				// e*cos(w+O)
const double Ini_g = 0.0;				// e*sin(w+O)
const double Ini_h = 0.694304;			// tan(i/2)*cos(O)
const double Ini_k = 1.045843;			// tan(i/2)*sin(O)
const double Ini_L = 7.267917;			// w+O+v
const double Ini_t = 1826.0;			// [days]
