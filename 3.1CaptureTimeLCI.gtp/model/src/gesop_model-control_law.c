...
const double deltaL[1] = {
	1555200,
}; 	// phase duration (seconds) = 18 days
// Needed to normalise the timescale within each phase

/* --- Initial guesses for initial state --- */

const double Ini_p = 4.8903628e7;			// [m] a(1-e²)
const double Ini_f = 0.089865;				// e*cos(w+O)
const double Ini_g = 0.316710;				// e*sin(w+O)
const double Ini_h = 0.645408;				// tan(i/2)*cos(O)
const double Ini_k = 0.993250;				// tan(i/2)*sin(O)
const double Ini_L = 6.529486;				// w+O+v
const double Ini_t = 1682.9534;				// [days]
...
const double p_ub =  1.0e8;		// For circular orbit at lunar radius. Will not be greater unless hyperbolic.
