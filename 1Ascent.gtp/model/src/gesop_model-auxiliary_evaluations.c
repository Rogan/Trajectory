 ...
 *   Constants -
 *--------------*/
static DLL_Group_Item Algebraic_Function_Names[96] =
	{
	...
	{"FBC_peri",				-1,	"Terminal condition: Periapsis",					-1, "None",				-1,"",-1	},	//78
	{"FBC_1",					-1,	"Terminal condition: ",								-1, "None",				-1,"",-1	},	//79
	{"IBC_a",					-1,	"Initial condition: a",								-1, "None",				-1,"",-1	},	//80
	{"IBC_e",					-1,	"Initial condition: e",								-1, "None",				-1,"",-1	},	//81
	{"IBC_i",					-1,	"Initial condition: i",								-1, "None",				-1,"",-1	},	//82
	{"IBC_m",					-1,	"Initial condition: m",								-1, "None",				-1,"",-1	},	//83
	{"IBC_0",					-1,	"Initial condition: ",								-1, "None",				-1,"",-1	},	//84
	{"IBC_1",					-1,	"Initial condition: ",								-1, "None",				-1,"",-1	},	//85
	{"IBC_2",					-1,	"Initial condition: ",								-1, "None",				-1,"",-1	},	//86
	{"IBC_3",					-1,	"Initial condition: ",								-1, "None",				-1,"",-1	},	//87
	{"IBC_4",					-1,	"Initial condition: ",								-1, "None",				-1,"",-1	},	//88
	{"AUX_energy_used",			-1,	"Energy used by thrusters",							-1, "Joule",			-1,"",-1	},	//89
	{"AUX_energy_generated",	-1,	"Energy generated by solar panels",					-1, "Joule",			-1,"",-1	},	//90
	{"AUX_oblateness_higher",	-1,	"Higher order Earth oblateness",					-1, "Meter/Second**2",	-1,"",-1	},	//91
	{"AUX_energy_integral",		-1,	"Integral of instantaneous power",					-1, "Joule",			-1,"",-1	},	//92
	{"AUX_energy_net",			-1,	"Difference of thruster and PV integral energies",	-1, "Joule",			-1,"",-1	},	//93
	{"AUX_oblateness_J2",		-1,	"Earth oblateness due to J2 harmonic",				-1, "Meter/Second**2",	-1,"",-1	},	//94
	{"AUX_julian_date",			-1,	"Julian Date",										-1, "Day",				-1,"",-1	},	//95
};
...
printf("Algebraic Functions\n");_flushall();
	...
	*error = 0;
	...
	// compute kepl. elements of moon's orbit
	...
	// compute earth coords in LCI and SEL
	for (i=1;i<=3;i++) {
...
//	outfun[58] =	kep_coords_MOP[5];//
	...
	outfun[80] =	1.0 - kep_coords_ECI[1]/2.445e7;
	...
	outfun[89] =	thruster_energy;
	outfun[90] =	solar_energy;
	outfun[91] =	dvec_abs(pertharm_rotrad_CS,3);
	outfun[92] =	net_energy;
	outfun[93] =	battery_level;
	outfun[94] =	dvec_abs(pertharm_rotrad2,3);
	outfun[95] =	julian_date;
