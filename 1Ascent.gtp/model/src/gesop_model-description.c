...
//		{"Science",	-1, "Science orbit: stationkeeping only",		-1},
	...
	static DLL_Item Terminal_Cost_Item =	{"TC_mass",	-1, "Maximise final mass and minimise orbital energy w.r.t. Moon",	-1};
	
	static DLL_Connected_Unit_Item States[9] =
	{
		{"pmee",		-1, "Modified Equinoctial Element p",			-1, "Meter",	-1, SOFT_CONNECT}, //0
		{"fmee",		-1, "Modified Equinoctial Element f",			-1, "None",		-1, SOFT_CONNECT}, //1
		{"gmee",		-1, "Modified Equinoctial Element g",			-1, "None",		-1, SOFT_CONNECT}, //2
		{"hmee",		-1, "Modified Equinoctial Element h",			-1, "None",		-1, SOFT_CONNECT}, //3
		{"kmee",		-1, "Modified Equinoctial Element k",			-1, "None",		-1, SOFT_CONNECT}, //4
		{"Lmee",		-1, "Modified Equinoctial Element L",			-1, "Radian",	-1, SOFT_CONNECT}, //5
		{"RealTime",	-1, "Real Time",								-1, "Day",		-1, SOFT_CONNECT}, //6
		{"Mass",		-1, "Mass",										-1, "Kilogram",	-1, SOFT_CONNECT}, //7
		{"Battery",		-1, "Battery charge",							-1,	"Joule",	-1, SOFT_CONNECT}, //8
	};
	...
	{
		{"Ini_T",			-1, "Start time (JD)",						-1,	"Day",		-1, SOFT_CONNECT},	// 0
		{"Thrust_Level",	-1, "Thrust magnitude",						-1, "None",		-1, NO_CONNECT},	// 1
		{"Delta_L",			-1, "Phase length (anomaly)",				-1, "Radian",	-1, NO_CONNECT},	// 2	
	};
	...
	static DLL_Constraint_Item IBCon[4] =
	{
		{"IBC_a",			-1, "a",					-1, true,	true},
		{"IBC_e",			-1, "e",					-1, true,	true},
		{"IBC_i",			-1, "i",					-1, true,	true},
		{"IBC_m",			-1, "m",					-1, true,	true},
	};
	
	static DLL_Constraint_Item FBCon[1]=
	{
		{"FBC_peri_phase1",			-1, "Ascend beyond VABs (phase 1)",					-1, false,	true},
//		{"FBC_p_ECI",				-1, "Near Moon (semilatus rectum, phase 2)",		-1, false,	true},
//		{"FBC_a_ECI",				-1, "Near Moon (semimajor axis, phase 2)",			-1, false,	true},
//		{"FBC_epsilon_ECI",			-1, "Near Moon (Earth orbital energy, phase 2)",	-1, false,	true},
//		{"FBC_epsilon_LCI",			-1, "Near Moon (Lunar orbital energy, phase 2)",	-1, false,	true},
//		{"FBC_r_LCI",				-1, "Near Moon (lunar radius, phase 2)",			-1, false,	true},
//		{"FBC_peri_phase2",			-1, "Near Moon (periapsis, phase 2)",				-1, false,	true},
//		{"FBC_epsilon_LCI",			-1, "Near Moon (lunar energy, phase 2)",			-1, false,	true},
	};

	static DLL_Constraint_Item PCon[5] =
	{
		{"PC_u",					-1, "Unit control vector",							-1, true,	true},
		{"PC_r_ECI",				-1, "Over 100km Earth altitude",					-1, false,	false},
		{"PC_e_ECI",				-1, "In Earth orbit",								-1, false,	false},
		{"PC_r_LCI",				-1, "Over 50km lunar altitude",						-1, false,	false},
		{"PC_i_ECI",				-1, "Prograde orbit",								-1, false,	false},
	};
