...
/* CURRENT PARAMETERS
const double Ini_a = 2.4455e7;			// [m]
const double Ini_e = 0.732;
const double Ini_i = 0.37873645;		// [rad] = 21.7°
const double Ini_w = 3.14159;			// [rad] = 180°
const double Ini_O = 0.0;				// [rad]
const double Ini_v = 0.0;				// [rad]
*/
const double Ini_p = 1.135e7;			// [m] a(1-e²)
const double Ini_f = 0.0;				// e*cos(w+O)
const double Ini_g = 0.732;				// e*sin(w+O)
const double Ini_h = 0.192;				// tan(i/2)*cos(O)
const double Ini_k = 0.0;				// tan(i/2)*sin(O)
const double Ini_L = 3.14159;			// w+O+v
const double Ini_t = -140.0;			// [days]
const double Ini_m = 250.0;				// [kg]
...
const double p_ub =  4.0e8;		// For circular orbit at lunar radius. Will not be greater unless hyperbolic.
