...
//		{"Science",	-1, "Science orbit: stationkeeping only",		-1},
	...
	static DLL_Item Terminal_Cost_Item =
		{"TC_mass",		-1, "Minimise final mass",	-1};
	...
	static DLL_Constraint_Item IBCon[2] =
	{
		{"IBC_r_LCI",			-1, "Lunar altitude",					-1, true,	true},
		{"IBC_m",				-1, "Mass",								-1, false,	true},
	};
	
	static DLL_Constraint_Item FBCon[6]=
	{
		{"FBC_a_LCI",			-1, "Semimajor axis",					-1, true,	true},
		{"FBC_e_LCI",			-1, "Eccentricity",						-1, false,	true},
		{"FBC_i_LCI",			-1, "Inclination",						-1, true,	true},
		{"FBC_o_LCI",			-1, "Argument of periapsis",			-1, true,	true},
		{"FBC_O_LCI",			-1, "RAAN",								-1, true,	true},
		{"FBC_v_LCI",			-1, "Anomaly",							-1, true,	true},
	};
