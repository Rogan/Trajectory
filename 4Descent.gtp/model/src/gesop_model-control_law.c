...
const double Ini_p = 3.1199333e6;		// [m] a(1-e²)
const double Ini_f = -0.001264;			// e*cos(w+O)
const double Ini_g = -0.006247;			// e*sin(w+O)
const double Ini_h = 0.665798;			// tan(i/2)*cos(O)
const double Ini_k = 1.039170;			// tan(i/2)*sin(O)
const double Ini_L = 8.0978565;			// w+O+v
const double Ini_t = 1701.0052;			// [days]
const double Ini_m = 100.0;				// [kg]
...
/* control bounds */
const double LB_Control = - 1.0;
const double UB_Control =   1.0;
...
const double k_lb = -2.0;		// [-]
const double k_ub =  2.0;		// ATTENTION : For i < 90.0 deg

const double L_lb = -20.0;		// [rad]
const double L_ub = 20000.0;

const double t_lb = 0.0;		// [days]
const double t_ub = 2200.0;
